...
local italic_keywords = false
local italic_functions = false
...
theme.set_highlights = function()
  ...
  hl(0, "Boolean", { fg = c.orange, bg = "NONE", bold = true })
  hl(0, "Constant", { fg = c.orange, bg = "NONE" })
  hl(0, "Type", { fg = c.cyan, bg = "NONE" })
  hl(0, "Function", { fg = c.blue, bg = "NONE", italic = italic_functions })
  hl(0, "Keyword", { fg = c.purple, bg = "NONE", italic = italic_keywords, bold = true })
  hl(0, "Conditional", { fg = c.yellow, bg = "NONE", italic = italic_conditionals, bold = true })
  hl(0, "Repeat", { fg = c.yellow, bg = "NONE", italic = italic_loops })
  ...
  hl(0, "SpecialComment", { fg = c.alt_fg, bg = "NONE" })
  ...
  hl(0, "LspHint", { fg = c.gray, bg = "#232730", italic = true })
